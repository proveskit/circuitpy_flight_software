...
class BatteryHelper:
    ...
    def _read_message(self, timeout_ms=150):
        ...
        start = time.monotonic()
        while (
            not self.uart.in_waiting and (time.monotonic() - start) * 1000 < timeout_ms
        ):
            pass
    ...
    def get_temperatures(self):
        ...
        try:
            ...
            return {"thermocouple": thermo_temp, "board": board_temp}
    ...
    def get_error_metrics(self):
        ...
        try:
            ...
            return {"error_count": error_count, "trust_memory": trust_memory}
        except (ValueError, AttributeError):
            return None
