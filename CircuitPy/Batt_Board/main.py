    ...
    async def g_face_data():
        ...
        while check_power():
            ...
            try:
                ...
                debug_print('Outta time! ' + ''.join(traceback.format_exception(e_gf))) #pylint: disable=no-value-for-parameter
    ...
    async def s_face_data():
        ...
        while check_power():
            try:
                ...
                debug_print('Outta time! ' + ''.join(traceback.format_exception(e_sf))) #pylint: disable=no-value-for-parameter
    ...
    async def detumble():
        ...
        while check_power():
            try:
                ...
                debug_print(f'Outta time!' + ''.join(traceback.format_exception(e_de))) #pylint: disable=no-value-for-parameter
...
try:
    ...
    try:
        ...
        debug_print("Error in Boot Sequence: " + ''.join(traceback.format_exception(e_bo))) #pylint: disable=no-value-for-parameter
    ...
    debug_print("Fatal Error in Main Loop: " + ''.join(traceback.format_exception(e))) #pylint: disable=no-value-for-parameter
    time.sleep(15)
